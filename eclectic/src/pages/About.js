  ...
  return (
    <div className="bg-gray-200">
      ...
      <div className="header">
        <Parallax
          className="w-full h-[40vh] md:h-[calc(100vh-5rem)] object-cover brightness-[.6]"
          bgImage={AboutUsParallax}
          strength={225}
        >
          <div className="flex items-center justify-center h-500">
            <p className="text-center uppercase font-extralight text-2xl md:text-4xl lg:text-6xl px-2 md:px-7 lg:px-4">
      ...
      <div className="my-8 text-center px-4 md:px-6 lg:px-8">
        <p className="tracking-widest font-semibold uppercase text-base md:text-lg lg:text-2xl p-4 text-black">
          Your Partner in Digital Innovation!
        </p>
        <p className="text-sm md:text-lg lg:text-xl px-4 md:px-8 lg:px-16 pb-4 font-extralight">
          Eclectic Dopetech Solutions: Bridging innovation and practicality. We
          create intuitive software that streamlines processes and drives
          business growth, leveraging cutting-edge technology to meet current
          demands and anticipate future challenges. Our solutions connect ideas,
          people, and opportunities, ensuring sustainable success in today's
          fast-paced digital landscape.
        </p>
      </div>

      {/* Mission Section */}
      <section className="grid grid-cols-1 md:grid-cols-2 p-4 md:p-10">
        ...
        <div className="p-4 md:p-8 my-8 text-center">
          <h2 className="text-lg md:text-xl font-bold">Our Mission</h2>
          <div className="h-1 mt-2 w-24 bg-[#75c4e9] mx-auto" />
          <p className="text-base md:text-xl mt-8 leading-8 font-extralight">
            Eclectic Dopetech Solutions aims to leverage the latest proven
            technologies and tools to create intuitive, user-friendly software
            that streamlines processes and drives sustainable business growth.
            By providing solutions that anticipate future challenges, we help
            businesses bridge ideas, people, and opportunities, ensuring
            long-term success and innovation in an ever-evolving digital
            landscape.
          </p>
        </div>
      </section>
      ...
      <div className="py-8">
        <div className="container mx-auto flex justify-center items-center flex-col">
          <h2 className="text-lg md:text-xl font-semibold mb-4">Our Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value) => (
              <div
                key={value.id}
                className="bg-slate-100 hover:scale-105 duration-300 ease-linear shadow-lg py-4 px-6 flex justify-start items-center gap-4 mx-4 md:mx-0 rounded-lg"
              >
                <div className="w-16 h-16 md:w-28 md:h-28 flex items-center justify-center bg-slate-100 rounded-full border border-blue-200 p-2">
                  <span className="text-2xl md:text-4xl text-blue-300">
                    {value.icon}
                  </span>
                </div>
